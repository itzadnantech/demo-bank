            ...
            <div class="buysell wide-xs m-auto">
                <div class="buysell-nav text-center">
                    <ul class="nk-nav nav nav-tabs nav-tabs-s2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link"
                                href="fund_user?accountnumber=<?php echo$_GET['accountnumber'] ?>&id=<?php echo$_GET['id'] ?>">Credit
                                Account</a>
                        </li>
                    </ul>
                </div><!-- .buysell-nav -->
                ...
                <div class="buysell-title text-center">
                    <h2 class="title">Debit money from <?php echo "$firstname $lastname $middlename"; ?>!</h2>
                </div><!-- .buysell-title -->
                    ...
                    <form action="" class="buysell-form" method="post">
                        ...
                        <div class="buysell-field form-group">
                            ...
                            <div class="buysell-field form-group">
                                ...
                                <div class="form-control-group">
                                    <select onchange="ShowTransferScope(this.value);" class="form-control form-control-lg form-control-number"
                                        id="scope" name="scope">
                                        <option value="">Select Transaction Scope</option>
                                        <option>Cash Withdrawal</option>
                                        <option value="International Transfer">International Wire Transfer</option>
                        ...
                        <div class="buysell-field form-group">
                            ...
                            <div class="form-control-group">
                                <input type="text" class="form-control form-control-lg form-control-number" id="memo"
                                    name="description" placeholder="the purpose of your transfer">
                                <div class="form-dropdown">
                ...
                <div class="nk-block-between-md g-4 card-bordered">
                    ...
                    <div class="nk-block-head-content">
                        <ul class="nk-block-tools gx-3">
                            <li><a href="account_manager" class="btn btn-primary"><span>Home</span> <em
            ...
            <table class="datatable-init table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="fund_user?accountnumber=<?php echo$rows['accountnumber'] ?>&id=<?php echo$rows['id']; ?>"
                                class="btn btn-success btn-sm">Fund User</a></td>
                    </tr>
                    <?php   }   ?>
                </tbody>
            </table>
