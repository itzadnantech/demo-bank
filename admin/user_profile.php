...
include("header.php"); ?>
    ...
    $password = decryptData($userdetails['password'],$userdetails['salt']);
                                        ...
                                        <div class="card-inner card-inner-lg">
                                            ...
                                            <div class="nk-block">
                                                <div class="nk-data data-list">
                                                    ...
                                                    <div class="data-item" data-toggle="modal" data-target="#profile-edit" data-tab-target="#address">
                                                        <div class="data-col">
                                                            <span class="data-label">User Passsword</span>
                                                            <!-- <span class="data-value"><?php echo$password ?> <br><span style="color: #0000ff;"><strong><a style="color: #0000ff;" href="https://www.md5online.org/md5-decrypt.html" target="_blank" rel="noopener">Click here to reveal password</a></strong></br></span></span> -->
