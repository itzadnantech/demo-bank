...
<div class="nk-content nk-content-fluid">
                    ...
                    <div class="card card-bordered card-preview">
                     <div class="card-header font-weight-bold text-light" style="background-color:#0b3175;">
...
<div class="modal fade" tabindex="-1" id="replyModal<?php echo$rows['id'] ?>" >
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header text-white" style="background-color:#1A4DBE; color: white;">
                <h5 class="modal-title"><?php echo$ticket?></h5>
            </div>
            <div class="modal-body bg-light">
                <p class="card-bordered rounded-sm p-1 bg-white"><?php echo$rows['message'] ?></p>
                <hr style="height:3px; background-color: #1A4DBE; border-radius:3px;">
